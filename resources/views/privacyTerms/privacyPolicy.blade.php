...
<h2 class="head1211">Log Files</h2>

<p>Rudra Stories follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>

<h2 class="head1211">Cookies and Web Beacons</h2>

<p>Like any other website, Rudra Stories uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
...
<h2 class="head1211">How to Delete Cookies</h2>
<p>Here are the steps for deleting cookies from modern web browsers.</p>
<br>
<h2 class="head1211">How to delete cookies on Google Chrome (Windows)</h2>
<ol>
...
<h2 class="head1211">How to delete cookies on Edge (Windows)</h2>
...
<h2 class="head1211">How to delete cookies on Mozilla Firefox (Windows)</h2>
...
<h2 class="head1211">How to delete cookies on Opera (Windows)</h2>
...
<h2 class="head1211">Google DoubleClick DART Cookie</h2>

<p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a></p>

<h2 class="head1211">Our Advertising Partners</h2>
...
<h2 class="head1211">Third Party Privacy Policies</h2>

<p>Rudra Stories's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </p>

<p>You can choose to disable cookies through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the browsers' respective websites.</p>

<h2 class="head1211">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
...
<h2 class="head1211">GDPR Data Protection Rights</h2>
...
<h2 class="head1211">Children's Information</h2>

<p>Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.</p>

<p>Rudra Stories does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>


<h2 class="head1211">Privacy Policy Changes</h2>
<p>
    Although most changes are likely to be minor, Bloggingos may change its Privacy Policy
    from time to time, and in Bloggingos's sole discreation.
</p>
<p>
    Bloggingos encourages visitors to frequently check this page for any changes to its Privacy Policy.
</p>
<p>
